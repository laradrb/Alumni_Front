...
const DropdownMediumButton = styled.button`
    width: 25rem;
    height: 2.063rem;
    padding: 1.2rem;
    border: none;
...
const DropdownMediumButtonComponent = ({ options, onSelect, buttonText }) => {
    ...
    return (
        <DropdownContainer>
            <DropdownMediumButton onClick={toggleDropdown} $isOpen={isOpen} type="button">
                {buttonText}
...
export default DropdownMediumButtonComponent;
